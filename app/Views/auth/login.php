...
<head>
    ...
    <style>
        ...
        .login-brand { text-align: center; padding: 2rem 2rem .5rem; }
        .login-brand .icon { width: 64px; height: 64px; background: linear-gradient(135deg,#0d6efd,#0d47a1); border-radius: 16px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: .75rem; }
        .login-brand .icon i { color: #fff; font-size: 1.75rem; }
        .login-brand h4 { font-weight: 700; color: #1a1a2e; margin: 0; }
        .login-brand p { color: #6c757d; font-size: .88rem; }
        .card-body { padding: 1.5rem 2rem 2rem; }
        .btn-login { background: linear-gradient(135deg,#0d6efd,#0d47a1); border: none; border-radius: 10px; padding: .65rem; font-weight: 600; }
        .form-control { border-radius: 10px; padding: .6rem 1rem; }
        .form-control:focus { box-shadow: 0 0 0 .2rem rgba(13,110,253,.2); }
    </style>
</head>
<body>
