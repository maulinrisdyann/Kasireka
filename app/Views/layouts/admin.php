...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="pt-2">
            ...
            <a href="<?= base_url('admin/payment-account') ?>" class="nav-link <?= str_starts_with(uri_string(), 'admin/payment-account') ? 'active' : '' ?>">
                <i class="fas fa-building-columns me-2"></i> Rekening Pembayaran
            </a>
